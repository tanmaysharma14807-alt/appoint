    ...
    <footer className="bg-surface border-t border-outline-variant/15">
      <div className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1">
          <span className="text-2xl font-headline italic text-on-surface block mb-6">The Modern Atelier</span>
      ...
      <div className="max-w-7xl mx-auto px-8 py-8 border-t border-outline-variant/10 text-center flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-xs uppercase tracking-widest text-on-surface-variant font-medium">© 2024 The Modern Atelier. All rights reserved.</p>
